...
{
	public partial class MenuItemToTaxRepository : IMenuItemToTaxRepository
	{
		...
		public MenuItemToTaxRepository(YumaPos.FrontEnd.Infrastructure.Configuration.IDataAccessService dataAccessService)
		{
		...
		/*
		public YumaPos.Server.Infrastructure.DataObjects.MenuItemToTax GetByItemIdAndTaxId(Guid itemId, Guid taxId, bool? isDeleted = false)
		{
		return _menuItemToTaxCacheRepository.GetByItemIdAndTaxId(itemId, taxId, isDeleted);
		}
		public async Task<YumaPos.Server.Infrastructure.DataObjects.MenuItemToTax> GetByItemIdAndTaxIdAsync(Guid itemId, Guid taxId, bool? isDeleted = false)
		{
		return await _menuItemToTaxCacheRepository.GetByItemIdAndTaxIdAsync(itemId, taxId, isDeleted);
		}
		...
		*/
		...
		/*
		public void UpdateByItemIdAndTaxId(YumaPos.Server.Infrastructure.DataObjects.MenuItemToTax menuItemToTax)
		{
		menuItemToTax.Modified = DateTimeOffset.Now;
		menuItemToTax.TaxVersionId = _menuItemToTaxVersionRepository.Insert(menuItemToTax);
		_menuItemToTaxCacheRepository.UpdateByItemIdAndTaxId(menuItemToTax);
		}
		public async Task UpdateByItemIdAndTaxIdAsync(YumaPos.Server.Infrastructure.DataObjects.MenuItemToTax menuItemToTax)
		{
		menuItemToTax.Modified = DateTimeOffset.Now;
		menuItemToTax.TaxVersionId = await _menuItemToTaxVersionRepository.InsertAsync(menuItemToTax);
		await _menuItemToTaxCacheRepository.UpdateByItemIdAndTaxIdAsync(menuItemToTax);
		}
		...
		*/
		...
		/*
		public void RemoveByItemIdAndTaxId(YumaPos.Server.Infrastructure.DataObjects.MenuItemToTax menuItemToTax)
		{
		menuItemToTax.IsDeleted = true;
		_menuItemToTaxCacheRepository.UpdateByItemIdAndTaxId(menuItemToTax);
		}
		public async Task RemoveByItemIdAndTaxIdAsync(YumaPos.Server.Infrastructure.DataObjects.MenuItemToTax menuItemToTax)
		{
		menuItemToTax.IsDeleted = true;
		await _menuItemToTaxCacheRepository.UpdateByItemIdAndTaxIdAsync(menuItemToTax);
		}
		public void RemoveByItemIdAndTaxId(Guid itemId)
		{
		var result = _menuItemToTaxCacheRepository.GetByItemIdAndTaxId(itemId);
		result.IsDeleted = true;
		UpdateByItemIdAndTaxId(result);
		}
		public async Task RemoveByItemIdAndTaxIdAsync(Guid itemId)
		{
		var result = await _menuItemToTaxCacheRepository.GetByItemIdAndTaxIdAsync(itemId);
		result.IsDeleted = true;
		await UpdateByItemIdAndTaxIdAsync(result);
		}
