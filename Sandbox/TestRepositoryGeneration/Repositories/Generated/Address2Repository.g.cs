...
namespace YumaPos.Server.Infrastructure.Repositories
{
	public partial class Address2Repository : RepositoryBase, IAddress2Repository
	{
		...
		private const string InsertQuery = @"INSERT INTO dbo.Addresses2([dbo].[Addresses2].[Country],[dbo].[Addresses2].[City],[dbo].[Addresses2].[State],[dbo].[Addresses2].[Street],[dbo].[Addresses2].[Building],[dbo].[Addresses2].[ZipCode],[dbo].[Addresses2].[Latitude],[dbo].[Addresses2].[Longitude]{columns}) OUTPUT INSERTED.Id VALUES(@Country,@City,@State,@Street,@Building,@ZipCode,@Latitude,@Longitude{values}) ";
		private const string UpdateQueryBy = @"UPDATE [dbo].[Addresses2] SET dbo.Addresses2.[Id] = @Id,dbo.Addresses2.[Country] = @Country,dbo.Addresses2.[City] = @City,dbo.Addresses2.[State] = @State,dbo.Addresses2.[Street] = @Street,dbo.Addresses2.[Building] = @Building,dbo.Addresses2.[ZipCode] = @ZipCode,dbo.Addresses2.[Latitude] = @Latitude,dbo.Addresses2.[Longitude] = @Longitude FROM [dbo].[Addresses2] ";
