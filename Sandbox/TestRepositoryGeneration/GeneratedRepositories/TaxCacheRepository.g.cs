...
namespace TestRepositoryGeneration
{
	internal partial class TaxCacheRepository : TestRepositoryGeneration.Infrastructure.RepositoryBase
	{
		...
		private const string UpdateFields = @"[Taxs].[TaxVersionId] = @TaxVersionId,[Taxs].[Name] = @Name,[Taxs].[Modified] = @Modified,[Taxs].[ModifiedBy] = @ModifiedBy,[Taxs].[IsDeleted] = @IsDeleted";
