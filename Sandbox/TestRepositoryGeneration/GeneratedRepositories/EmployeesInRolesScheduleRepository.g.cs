...
namespace TestRepositoryGeneration
{
	public partial class EmployeesInRolesScheduleRepository : TestRepositoryGeneration.Infrastructure.RepositoryBase, TestRepositoryGeneration.RepositoryInterfaces.IEmployeesInRolesScheduleRepository
	{
		...
		private const string InsertManyValuesTemplate = @"({0},{1},{2},{3},{4},{5},{6},{7},@TenantId)";
		private const string NoCheckConstraint = @"ALTER TABLE [EmployeesInRolesSchedule] NOCHECK CONSTRAINT ALL";
		private const string CheckConstraint = @"ALTER TABLE [EmployeesInRolesSchedule] CHECK CONSTRAINT ALL";
