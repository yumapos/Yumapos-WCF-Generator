...
namespace TestRepositoryGeneration
{
	public partial class AddressArchiveRepository : TestRepositoryGeneration.Infrastructure.RepositoryBase, TestRepositoryGeneration.RepositoryInterfaces.IAddressArchiveRepository
	{
		...
		*/
		/*
		public IEnumerable<TestRepositoryGeneration.DataObjects.BaseRepositories.Address> GetById(System.Guid id, bool? isDeleted = false)
		{
		...
		public async Task<IEnumerable<TestRepositoryGeneration.DataObjects.BaseRepositories.Address>> GetByIdAsync(System.Guid id, bool? isDeleted = false)
		{
		object parameters = new {id, isDeleted};
		var sql = SelectByQuery + WhereQueryById;
		if (isDeleted.HasValue)
		...
		*/
		/*
		public IEnumerable<TestRepositoryGeneration.DataObjects.BaseRepositories.Address> GetByCountry(string country, bool? isDeleted = false)
		{
		...
		public async Task<IEnumerable<TestRepositoryGeneration.DataObjects.BaseRepositories.Address>> GetByCountryAsync(string country, bool? isDeleted = false)
		{
		object parameters = new {country, isDeleted};
		var sql = SelectByQuery + WhereQueryByCountry;
		if (isDeleted.HasValue)
		...
		*//*
		public IEnumerable<TestRepositoryGeneration.DataObjects.BaseRepositories.Address> GetByCountryAndCity(string country, string city, bool? isDeleted = false)
		{
