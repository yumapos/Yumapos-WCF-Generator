...
{
    internal class CodeClassGeneratorÑacheRepository : BaseCodeClassGeneratorRepository
    {
        ...
        {
            get { return RepositoryInfo.ClassName + "Ñache" + RepositoryInfo.RepositorySuffix; }
        }
